...
resource "aws_db_parameter_group" "custom_default_param_group" {
  family      = "mysql8.0"                                #parametre grubu oluşturmak içindir. AWS RDS parametre grupları, veritabanı
  description = "My custom default parameter group"       #sunucusunun veya motorunun davranışını, yapılandırmasını ve özelliklerini yönetmek için kullanılır.
